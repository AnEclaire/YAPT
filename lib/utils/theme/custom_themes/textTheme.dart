...
class HTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    headlineLarge: const TextStyle().copyWith(fontSize: 32.0, fontWeight: FontWeight.bold, color: Colors.black, fontFamily: 'October_Crow'),
    ...
    bodyLarge: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w700, color: Colors.black.withOpacity(0.5)),
    ...
    labelLarge: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w800, color: Colors.black, fontFamily: 'Yahfie'),
  ...
  static TextTheme darkTextTheme = TextTheme(
    headlineLarge: const TextStyle().copyWith(fontSize: 32.0, fontWeight: FontWeight.bold, color: Colors.white, fontFamily: 'October_Crow'),
    ...
    bodyLarge: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w700, color: Colors.white.withOpacity(0.5)),
    ...
    labelLarge: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w800, color: Colors.white, fontFamily: 'Yahfie'),
