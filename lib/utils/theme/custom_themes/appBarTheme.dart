...
class HAppBarTheme {
  ...
  static const lightAppBarTheme = AppBarTheme(
    ...
    titleTextStyle: TextStyle(fontSize: 18.0, fontWeight: FontWeight.w600, color: HColors.black),
  );
  ...
  static const darkAppBarTheme = AppBarTheme(
    ...
    titleTextStyle: TextStyle(fontSize: 18.0, fontWeight: FontWeight.w600, color: HColors.white),
  );
}